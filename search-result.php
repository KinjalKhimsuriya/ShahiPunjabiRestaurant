        ...
        <div class="page-title-wrapper text-center">
            <div class="col-md-12 col-sm-12 col-lg-12">
                <div class="page-title-inner">
                    <h1 itemprop="headline">Search Results of "<?php echo $_POST['searchdata']; ?>"</h1>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="remove-ext">
                            <div class="row">
                                ...
                                ?>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-lg-4">
                                            <div class="popular-dish-box style2 wow fadeIn" data-wow-delay="0.2s">
                                                <div class="popular-dish-thumb">
                                                    <a href="food-detail.php?fid=<?php echo $row['ID']; ?>" title="" itemprop="url">
                                                        <img src="admin/itemimages/<?php echo $row['Image']; ?>" alt="<?php echo $row['ItemName']; ?>" itemprop="image" width="400" height="180">
                                                    </a>
                                                </div>
                                                <div class="popular-dish-info">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <span class="price">₹ <?php echo $row['ItemPrice']; ?></span><br>
                                    ...
                                    echo "<h3 style='color:red';>No data found for your search.</h3>";
                                }
                                ?>
                            </div>
                        </div>
                            ...
                            <ul class="pagination justify-content-center">
                                ...
                                <?php if ($page_no < $total_no_of_pages) { ?>
                                    <li class="page-item next">
                                        <a class="page-link brd-rd2" href='?page_no=<?php echo $total_no_of_pages; ?>'>Last &rsaquo;&rsaquo;</a>
                                    </li>
                                <?php } ?>
