...
<head>
    <title>Shahi Punjabi Restaurant | home</title>
    <style>
        .blackish:before {
    ...
    <div class="block blackish opac90">
        ...
        <div class="restaurant-searching style2">
            <div class="restaurant-searching-inner">
                <span>Welcome to Shahi Punjabi Food</span>
                <h3 itemprop="headline">Order and it will be delivered</h3>
                                    ...
                                    <div class="popular-dish-box style2 wow fadeIn" data-wow-delay="0.2s">
                                        ...
                                        <div class="popular-dish-info">
                                            ...
                                            <form method="post">
                                                ...
                                                <a class="btn pull-right red-bg brd-rd3" href="login.php" style="color:white;" title="Login">Order Now</a>
                                                <?php } else {?>
                                                <button type="submit" name="addcart"
                                                    class="btn pull-right red-bg brd-rd3" style="color:white;">Order Now</button>
                                                <?php } ?>
                                            </form>
                                        </div>
                                    </div>
