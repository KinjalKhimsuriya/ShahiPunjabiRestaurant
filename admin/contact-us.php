...
?>
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="contact-us.php?del=<?php echo $row['id'];?>" style="color:red;" onclick="return confirm('Do you really want to delete the category?');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
