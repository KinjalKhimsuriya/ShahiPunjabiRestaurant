...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="editfooditem.php?editid=<?php echo $row['ID'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> | 
                    <a href="manage-fooditems.php?delfood=<?php echo $row['ID'];?>" style="color:red;" onclick="return confirm('Do you really want to delete the food item?');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
